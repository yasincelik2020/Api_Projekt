...
public class D27_PostRequestObjectMapperUtils extends BookerBaseUrl {
     /*
    Given
 ...
 */
    ...
    @Test
    void postRequestObjectMapperUtilsTest(){
        //Set the url
        ...
        //Do the assertion
        BookingResponsePojo actualData = ObjectMapperUtils.jsonToJava(response.asString(),BookingResponsePojo.class);
        // response.asString() yaparak da cevirebiliriz.
