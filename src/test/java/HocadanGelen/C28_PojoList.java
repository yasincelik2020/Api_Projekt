...
*/
    ...
    void pojoListTest() throws JsonProcessingException {
        ...
        JsonPlaceHolderPojo expectedData = jsonToJava(json, JsonPlaceHolderPojo.class);
        ...
        //Burada bir list içinde dönen json dataları list içerise pojo class objeleri şeklinde atıyoruz.
        ...
        for (JsonPlaceHolderPojo w : toDolist) {
            ...
            if (w.getTitle().equals("et porro tempora")){//Bu title'a eşit titla'a sahip elemanın indeksi bulunuyor.
                break;
            }
            idx++;
